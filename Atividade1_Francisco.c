...
// Analise: Analisando o resultado do algoritmo na tabela é possivel perceber ue quanto maior é o tamanho maior é o tempo, já que tambem aumentam os numeros de comparações e movimentações.
// Ao analisar no tamanho 1000 se nota que o tempo do Selection Sort( 83.00 ) foi bem menor que o do Bubble Sort
